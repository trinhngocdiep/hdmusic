!function (e, t) {
    ...
    return function (e) {
        ...
        (function (t) {
            "use strict";
            var n = r(4), o = r(8), i = r(3), a = r(9), s = r(2).Promise, u = r(16), l = r(17);
            e.exports = t.SC = {
                initialize: function () {
                    ...
                    return n.resolve(e)
                }, Recorder: u, Promise: s, stream: function (e, t) {
                    return l(e, t)
        ...
        e.exports = function (e) {
            ...
            !function (t, n) {
                ...
                return function (e) {
                    ...
                    "use strict";
                    function n(e) {
                        return new i({startPos: 0, endPos: e, startLevel: 0, endLevel: 1, fromEnd: !1})
                    }

                    function o(e) {
                        return new i({startPos: e, endPos: 0, startLevel: 1, endLevel: 0, fromEnd: !0})
                    }

                    Object.defineProperty(t, "__esModule", {value: !0}), t.buildFadeIn = n, t.buildFadeOut = o;
                    var i = function () {
                        function e(e) {
                            var t = e.startPos, r = e.endPos, n = e.startLevel, o = e.endLevel, i = e.fromEnd, a = void 0 !== i && i;
                        ...
                        return e.prototype.calculate = function (e, t) {
                            var r = this._fromEnd ? t - 500 - this._startPos : this._startPos, n = this._fromEnd ? t - 500 - this._endPos : this._endPos;
                            if (e < r)return {level: this._startLevel, nextCalculatePosition: r - e};
                            if (e <= n) {
                                var o = (e - r) / (n - r), i = Math.cos(o * Math.PI) / -2 + .5, a = this._startLevel + (this._endLevel - this._startLevel) * i;
                                return {level: a, nextCalculatePosition: e}
                            }
                            return {level: this._endLevel, nextCalculatePosition: 1 / 0}
                        }, e
                    }();
                    t.Fade = i
                }, function (e, t, r) {
                    ...
                    Object.defineProperty(t, "__esModule", {value: !0});
                    var i = r(0), a = r(3), s = i.eventDispatcher.EventDispatcher, u = i.helpers.Promise, l = i.helpers.deferred.buildDeferred, c = 100, d = 5e3, p = 1500, h = function (e) {
                        function t(t, r) {
                        ...
                        return o(t, e), t.prototype.reload = function () {
                            ...
                            var e = this, t = this.isLoading() && "navigator"in window && !window.navigator.onLine;
                            ...
                            if (this._volumeAutomationSupported) {
                                ...
                                if (null !== t) {
                                    var r = this._volumeAutomators, o = this.getPosition(), i = 1 / 0, a = 1;
                                    r.forEach(function (e) {
                                        var r = e.calculate(o, t), s = r.nextCalculatePosition, u = r.level;
                                        a *= n(0, 1, u), s < i && (i = s)
                            ...
                            var e = this.getPlayer(), t = e && e.getBufferController();
                    ...
                    function i(e, t, r, i, s, u, l, c, d) {
                        ...
                        var p = null, h = !1, f = n(c);
                        r.onError.subscribe(function (t) {
                            if (!(t instanceof a.errors.NotSupportedError)) {
                                if (i) {
                                    if (t instanceof a.errors.URLUpdateError)return d.error("URL refresh failed for some reason.", t), void s({retryPlayer: !0});
                                    if (o(e, t)) {
                                        if (h)return;
                                        return d.info("Got a 403 status code. Peforming a URL refresh..."), h = !0, p = l.getUrl(), void p.whenComplete().then(function (e) {
                                            if (e) {
                                                var t = e.url, o = e.rendition;
                                                n(t) !== f || JSON.stringify(u) !== JSON.stringify(o) ? (d.warn("Got a new URL but the rendition did not match the original."), s({retryPlayer: !1})) : (h = !1, d.info("Got a new URL. Updating..."), r.getUrlController().updateUrl(t))
                                            } else d.warn("Could not get a new URL."), s({retryPlayer: !1})
                                        }).catch(function (e) {
                                            d.error("Unexpected error when trying to retrieve a new URL.", e), s({retryPlayer: !1})
                                        })
                                    }
                                }
                                d.error("Unexpected player error.", t), s({retryPlayer: !1})
                            }
                        }), t.providePlayer(r)
                    }
                    ...
                    "use strict";
                    Object.defineProperty(t, "__esModule", {value: !0});
                    var n, o = r(1), i = r(9), a = r(2), s = r(11), u = r(12), l = r(10);
                    !function (e) {
                    ...
                    function m(e) {
                        ...
                        function r() {
                            ...
                            var e = new q(function () {
                                function e() {
                                    function t(e) {
                                        if (e !== E.helpers.abortableJob.abortedError)if (e instanceof A.RequestError) {
                                    ...
                                    s = o(), s.onCompletion(function (r) {
                                        if (r)try {
                                            Me = r;
                                            var o = r.url, i = r.rendition, s = new E.Descriptor(o, i.maestroProtocol, i.maestroFormat), u = a(Te, s, r);
                                ...
                                function n(e) {
                                    function n(e) {
                                        if (!o && !i && (o = !0, Pe.debug("Player releasing control.", e), t.abort(e), !Re.isDead()))if (e && e.retryPlayer) {
                                            var n = Oe.getDelay();
                                ...
                                var i = !1, s = null;
                                return e(), {
                                    result: E.helpers.deferred.buildDeferred().promise, abort: function (e) {
                            ...
                            return z(function () {
                                return new q(function () {
                                    ...
                                    var t = e.whenComplete().then(function (e) {
                                        return Pe.debug("Retrieved URL.", e), e && te.indexOf(e.rendition) < 0 ? (Pe.warn("Unknown rendition. Skipping...", e.rendition), {success: !1}) : {
                                            result: e,
                                            success: !0
                                        }
                                    }).catch(function (e) {
                                        if (e instanceof A.RequestError) {
                                            var t = e.getStatusCode();
                                            if (null === t || 0 === t)return null === t ? Pe.warn("Timed out when retrieving URL. Will retry.") : Pe.warn("Network error when retrieving URL. Will retry."), {success: !1}
                                        }
                                        throw e !== E.helpers.abortableJob.abortedError && Pe.error("Error retrieving URL.", e), e
                                    });
                                    return {
                                        result: t, abort: function () {
                                            return e.abort()
                                        }
                                    }
                                })
                        ...
                        function a(e, t, r) {
                            ...
                            if ($ && l.indexOf($) >= 0 && e.indexOf($) < 0) {
                                if (Pe.debug("ChromecastPlayer found.", Y.version), me)return function () {
                                    var e = new $(t, {name: Ee, castContext: me, logger: re});
                                    return Re.providePlayer(e, {syncPosition: !1, syncVolume: !1}, !1), e
                                };
                            ...
                            return Z && l.indexOf(Z) >= 0 && e.indexOf(Z) < 0 ? (Pe.debug("FlipperPlayer found.", W.version), function () {
                                var e = new Z(t, {name: Ee, logger: re});
                                ...
                                var n = new X(t, {
                                    ...
                                    expectedSegmentFormat: {mimeType: "audio/mpeg"},
                                    logger: re
                                });
                                return u(n, function () {
                                    return e()
                                ...
                                var r = new Q(t, {name: Ee, logger: re});
                                u(r, function () {
                                    return e()
                                });
                                var o;
                                if (ve) {
                                    ...
                                    o = {urlExpires: !0, timeUrlRetrieved: n}
                                } else o = {urlExpires: !1};
                        ...
                        var l = e.playerClasses, c = e.streamUrlRetriever, d = e.duration, f = void 0 === d ? null : d, _ = e.preloadingEnabled, g = void 0 !== _ && _, y = e.pausedMaxBufferLength, v = void 0 === y ? 2e3 : y, m = e.playingMaxBufferLength, N = void 0 === m ? 9e4 : m, B = e.fadeOutDuration, H = void 0 === B ? 0 : B, ee = e.logger, re = void 0 === ee ? E.logger.noOpLogger : ee, ce = e.audioPerformanceReporter, de = e.audioReporter, pe = e.audioCheckpointInterval, he = void 0 === pe ? 3e4 : pe, fe = e.errorReporter, _e = e.urlProviderRetryDelayCalculator, ge = void 0 === _e ? G() : _e, ye = e.streamUrlsExpire, ve = void 0 === ye || ye, me = e.chromecastContext;
                        ...
                        var Ee = "SCAudio-" + ++ie, be = c.getTrackId();
                        null !== be && (Ee += "-" + be);
                        var we = new F.LogCollector;
                        re = E.logger.cloneLogger(we, re);
                        var Pe = E.logger.prefixLogger(re, Ee), Se = h();
                        Pe.info("Building player...", {ua: navigator.userAgent, logId: Se});
                        var Re = new T.Player({
                            name: Ee + "-Proxy",
                            logger: re,
                        ...
                        var Te = [], Ae = null, Me = null, ke = null, xe = null, De = null, Oe = new j.DecayingExponentialDelayCalculator;
                        if (ce && (xe = new S.AudioPerformanceEventGenerator(Re, ce, Pe, t, X)), de && new U.AudioEventGenerator(Re, de, he, Pe), fe && R.generateErrorEvents(Re, we, Se, be, fe, Pe, t, J || null, ve), Re.onChange.subscribe(function (e) {
                                var t = e.dead, r = e.playing;
                                if (t)Pe.info("Player killed."), ae.splice(ae.indexOf(Re), 1), ke && ke.abort(), De && window.clearTimeout(De); else if (r === !0) {
                                    var o = l.some(function (e) {
                                        return i(e)
                                    });
                                    o && n()
                                }
                            }), null !== f && (Pe.debug("Setting initial duration.", f), Re.setInitialDuration(f)), g)Pe.debug("Preloading is enabled, so performing retrieve immediately."), r(); else {
                            ...
                            }, Ie = Re.onPreloadingEnabled.subscribe(Ce), Le = Re.onPlayIntent.subscribe(Ce)
                        }
                        return Re
                    }

                    Object.defineProperty(t, "__esModule", {value: !0});
                    var E = r(0), b = r(35), w = r(4), P = r(3), S = r(17), R = r(22), T = r(5), A = r(7), M = r(9), k = r(1), x = r(12), D = r(2), O = r(11), C = r(20), I = r(8), L = r(19), N = r(6), j = r(21), F = r(23), U = r(16), B = r(18), q = E.helpers.abortableJob.AbortableJob, H = E.helpers.retry, z = H.retry, G = H.buildExponentialDelayCalculator, V = r(10), K = void 0;
                    try {
                        K = r(34)
                    } catch (e) {
                    }
                    ...
                    var Q = K ? K.HTML5Player : null, X = J ? J.HLSMSEPlayer : null, Z = W ? W.FlipperPlayer : null, $ = Y ? Y.ChromecastPlayer : null, ee = /^[^?#]*/, te = Object.keys(N.renditions).map(function (e) {
                        return N.renditions[e]
                    }), re = null, ne = null, oe = {}, ie = -1, ae = [], se = 1, ue = !1, le = new B.CacheManager(5e8, E.logger.noOpLogger);
                    ...
                    var n = r(0), o = 1e3, i = function () {
                        ...
                        return e.prototype._startReporting = function () {
                            var e = this, t = this._player;
                            t.onChange.subscribe(function (r) {
                                var n = r.actuallyPlaying, o = r.ended;
                            ...
                            var r = {type: e, position: this._player.getPosition(), duration: t};
                    ...
                    var n = r(0), o = r(30), i = function () {
                        ...
                        return e.prototype.reportManualEvent = function (e) {
                            ...
                            var e = this, t = this._player, r = new o.Timer, n = null, i = null;
                            t.onChange.subscribe(function (a) {
                                var s = a.dead, u = a.playing, l = a.actuallyPlaying, c = a.seeking, d = a.loading;
                    ...
                    var o = r(0), i = 2e4, a = function () {
                        ...
                        return e.prototype.addPlayer = function (e) {
                            ...
                            var t = this._players.reduce(function (e, t) {
                                ...
                                playingPlayers: [],
                                pausedPlayers: []
                            }), r = t.playingPlayers, o = t.pausedPlayers, a = r.reduce(function (e, t) {
                                return e + (t.getMemoryCacheUsage() || 0)
                            }, 0), s = o.reduce(function (e, t) {
                                return e + (t.getMemoryCacheUsage() || 0)
                            }, 0);
                    ...
                    function n(e, t, r, n) {
                        r = o.logger.prefixLogger(r, "FlipperPlayer Controller"), n && t.onAudioPerformanceEvent.subscribe(function (e) {
                            var t = e.protocol, o = e.type, i = e.latency, a = e.player_type, s = e.host, u = e.bitrate, l = e.format, c = "Flipper";
                            if (a !== c)return void r.warn("Ignoring audio performance event from flipper because the player_type was incorrect.", a);
                            var d = {protocol: t, type: o, latency: i, playerType: c, host: s, bitrate: u, format: l};
                    ...
                    function n(e, t, r, n, a, s) {
                        function u() {
                            var e = r.getDuration(), t = l();
                            if (null !== e && null !== t) {
                                var n = e - r.getPosition();
                                i() + n > t && (s.info("Releasing control because stream URL would expire before reaching end."), a({retryPlayer: !0}))
                            }
                        }
                        ...
                        s = o.logger.prefixLogger(s, "HTML5Player Controller"), r.onError.subscribe(function (t) {
                            t instanceof o.errors.NotSupportedError || (t instanceof e.errors.NetworkError && c() ? (s.info("Releasing control as a network error occurred, and the URL has expired."), a({retryPlayer: !0})) : (s.error("Unexpected player error.", t), a({retryPlayer: !1})))
                    ...
                    Object.defineProperty(t, "__esModule", {value: !0});
                    var o = r(0), i = o.helpers.time.now;
                    ...
                    var o = function () {
                        ...
                        return e.prototype.getLog = function () {
                            ...
                            this._push({level: "debug", msg: e, data: n(t), time: Date.now()})
                        }, e.prototype.info = function (e) {
                            for (var t = [], r = 1; r < arguments.length; r++)t[r - 1] = arguments[r];
                            this._push({level: "info", msg: e, data: n(t), time: Date.now()})
                        }, e.prototype.warn = function (e) {
                            for (var t = [], r = 1; r < arguments.length; r++)t[r - 1] = arguments[r];
                            this._push({level: "warn", msg: e, data: n(t), time: Date.now()})
                        }, e.prototype.error = function (e) {
                            for (var t = [], r = 1; r < arguments.length; r++)t[r - 1] = arguments[r];
                            this._push({level: "error", msg: e, data: n(t), time: Date.now()})
                    ...
                    "use strict";
                    Object.defineProperty(t, "__esModule", {value: !0}), t.apiMobile = {
                        scProtocol: "sc.api-mobile",
                        maestroProtocol: {name: "sc.api-mobile"},
                        maestroFormat: {}
                    }
                }, function (e, t, r) {
                    "use strict";
                    Object.defineProperty(t, "__esModule", {value: !0}), t.encryptedHlsMp3 = {
                        scProtocol: "encrypted-hls",
                        scFormat: "mp3",
                        maestroProtocol: {name: "hls"},
                        maestroFormat: {mimeType: "application/x-mpegURL"}
                    }
                }, function (e, t, r) {
                    "use strict";
                    Object.defineProperty(t, "__esModule", {value: !0}), t.hlsMp3 = {
                        scProtocol: "hls",
                        scFormat: "mp3",
                        maestroProtocol: {name: "hls"},
                        maestroFormat: {mimeType: "application/x-mpegURL"}
                    ...
                    "use strict";
                    Object.defineProperty(t, "__esModule", {value: !0}), t.httpMp3 = {
                        scProtocol: "http",
                        scFormat: "mp3",
                        maestroProtocol: {name: "http"},
                        maestroFormat: {mimeType: "audio/mpeg"}
                    }
                }, function (e, t, r) {
                    "use strict";
                    Object.defineProperty(t, "__esModule", {value: !0}), t.maestroChromecast = {
                        scProtocol: "maestro.chromecast",
                        maestroProtocol: {name: "maestro.chromecast"},
                        maestroFormat: {}
                    }
                }, function (e, t, r) {
                    "use strict";
                    Object.defineProperty(t, "__esModule", {value: !0});
                    var n = r(27), o = r(26), i = r(25), a = r(24), s = r(28);
                    t.renditions = {
                        httpMp3: n.httpMp3,
                        hlsMp3: o.hlsMp3,
                    ...
                    "use strict";
                    Object.defineProperty(t, "__esModule", {value: !0});
                    var n = r(0), o = n.helpers.time.now, i = function () {
                        function e() {
                    ...
                    Object.defineProperty(t, "__esModule", {value: !0}), t.version = "11.0.4", t.buildNumber = 275;
                    var o = r(15);
            ...
            !function (t, r) {
                ...
                return function (e) {
                    ...
                    "use strict";
                    function n() {
                        var e, t, r = !1, n = new o.Promise(function (r, n) {
                            e = r, t = n
                        });
                        return {
                            promise: n, resolve: function (t) {
                                r || (r = !0, e(t))
                            }, reject: function (e) {
                                r || (r = !0, t(e))
                            }, isSettled: function () {
                    ...
                    var n = r(6), o = function () {
                        ...
                        return e.prototype.subscribe = function (e) {
                            ...
                            var r = this, o = "number" == typeof t ? {time: t} : t || {}, i = void 0 !== o.time ? o.time : n.now(), a = this._listeners;
                            a.forEach(function (t) {
                                return t.payloads.push({time: i, payload: e})
                            });
                            var s = !1;
                            do s = !a.some(function (e) {
                                var t = e.fn, n = e.payloads, o = n.shift();
                    ...
                    Object.defineProperty(t, "__esModule", {value: !0});
                    var o = r(17), i = r(0), a = r(11), s = r(2), u = r(1), l = r(5), c = r(6), d = r(9), p = r(3), h = r(31), f = "undefined" != typeof navigator && "mediaSession"in navigator, _ = 5e3, g = f ? navigator.mediaSession : null, y = function () {
                        function e(e) {
                            var t = this;
                            ...
                            this._logger = p.prefixLogger(e.logger, "BasePlayer" + (r ? "-" + r : "")), this._mediaSessionEnabled = !!e.mediaSessionEnabled, this.onError = this._onError.getHandle(), this.whenReady = this._readyDeferred.promise, this._stateManager.subscribe(function (e, r) {
                                ...
                                var n = e.playing, o = r.dead;
                                o || void 0 === n || t._handlePlayPauseChange(n)
                            }), this._stateManager.subscribe(function (e, r) {
                                var n = e.seek, o = r.dead;
                        ...
                        return e.prototype.isReady = function () {
                            ...
                            var e = this._stateManager.getState(), t = e.actuallyPlaying, r = e.stalled;
                            return t && !r ? this.getPosition() : this._positionWhenStoppedPlaying
                        }, e.prototype.getListenTime = function () {
                            var e = this._stateManager.getState(), t = e.actuallyPlaying, r = e.ended, n = this._listenTimeBase;
                            ...
                            var e = this._stateManager.getState(), t = e.ready, r = e.duration;
                            return t ? r : null
                        }, e.prototype.setVolume = function (e) {
                            if (e < 0 || e > 1)throw new Error("Volume must be >= 0 and <= 1.");
                            this._setVolume(e)
                        }, e.prototype.getCurrentBufferedTimeRange = function () {
                            var e = this.getBufferedTimeRanges(), t = this.getPosition();
                            ...
                            return this._stateManager.update(function (t) {
                                var r = t.duration, n = e === r && t.ready;
                                t.ended = n
                            })
                        }, e.prototype._calculateState = function (e) {
                            var t = e.dead, r = e.loading, n = e.playing, o = e.ended;
                            ...
                            var e = this, t = this._errors;
                            this._errors = [], t.forEach(function (t) {
                                return e._onError.dispatch(t)
                            })
                        }, e.prototype._onChange = function (e, t) {
                            var r = this, n = e.ready, o = e.dead, i = e.fatalError, a = e.playing, s = e.actuallyPlaying, u = e.ended;
                            ...
                            if (t.playDeferred && !t.playDeferred.isSettled() && t.actuallyPlaying && (this._logger.debug("Resolving play deferred."), t.playDeferred.resolve(void 0)), !t.pauseDeferred || t.pauseDeferred.isSettled() || t.actuallyPlaying || (this._logger.debug("Resolving pause deferred."), t.pauseDeferred.resolve(void 0)), s === !0 && !t.ended || u === !1 && t.actuallyPlaying ? this._timePlaybackStarted = c.now() : (s === !1 && !t.ended || u === !0 && t.actuallyPlaying) && (this._listenTimeBase += c.now() - this._timePlaybackStarted, this._timePlaybackStarted = null), this._queuedSeekDeferreds = this._queuedSeekDeferreds.filter(function (e) {
                                    var n = e.position, o = e.deferred;
                                    if (t.seek)if ("IN_PROGRESS" !== t.seek.state) {
                                ...
                                this._queuedSeekDeferreds.forEach(function (e) {
                                    var t = e.position, n = e.deferred, o = i || new Error("Seek aborted as player killed.");
                    ...
                    Object.defineProperty(t, "__esModule", {value: !0});
                    var o = r(7), i = r(4), a = r(0), s = r(3), u = function (e) {
                        function t(t) {
                        ...
                        return n(t, e), t.prototype.getVolume = function () {
                            ...
                            return this._unsynced = !1, this._logger.debug("Syncing..."), r.isDead() ? void this._logger.debug("Provided player is dead.") : (this._errorHandler = r.onError.subscribe(function (e) {
                                ...
                                try {
                                    ...
                                    if (e.syncVolume && (r.setVolume(t._volume), r.setMuted(t._muted)), e.syncPosition)r.getPosition() !== t._position && (t._logger.debug("Seeking to match position."), r.seek(t._position)); else {
                                        var o = t.getSeekState();
                                        if (r.getPosition() !== t._position && o && "IN_PROGRESS" === o.state)t._logger.debug("Seeking to match position because a seek has been queued."), r.seek(t._position); else {
                            ...
                            var t = e.getSeekState(), r = this.getSeekState();
                     ...
                     */
                        !function (t, r) {
                            ...
                            function l() {
                                var e = 0, t = new $(p), r = document.createTextNode("");
                            ...
                            function f(e, t) {
                                var r = arguments, n = this, o = new this.constructor(g);
                                void 0 === o[oe] && L(o);
                                var i = n._state;
                                return i ? !function () {
                                    var e = r[i - 1];
                            ...
                            function O(e, t, r, n) {
                                var i = o(r), a = void 0, s = void 0, u = void 0, l = void 0;
                                if (i) {
                            ...
                            var K = V, J = 0, W = void 0, Y = void 0, Q = function (e, t) {
                                re[J] = e, re[J + 1] = t, J += 2, 2 === J && (Y ? Y(p) : ne())
                            }, X = "undefined" != typeof window ? window : void 0, Z = X || {}, $ = Z.MutationObserver || Z.WebKitMutationObserver, ee = "undefined" == typeof self && "undefined" != typeof t && "[object process]" === {}.toString.call(t), te = "undefined" != typeof Uint8ClampedArray && "undefined" != typeof importScripts && "undefined" != typeof MessageChannel, re = new Array(1e3), ne = void 0;
                            ne = ee ? s() : $ ? l() : te ? c() : void 0 === X ? h() : d();
                            var oe = Math.random().toString(36).substring(16), ie = void 0, ae = 1, se = 2, ue = new x, le = new x, ce = 0;
                            return N.prototype._enumerate = function () {
                                ...
                                if (n === _) {
                                    var o = m(e);
                                    if (o === f && e._state !== ie)this._settledAt(e._state, t, e._result); else if ("function" != typeof o)this._remaining--, this._result[t] = e; else if (r === z) {
                                        var i = new r(g);
                    ...
                    var i = function () {
                        ...
                        return e.prototype.run = function () {
                            ...
                            var r = this._jobControl, i = this._promise;
                            this._counter++;
                            var a = n.buildDeferred(), s = !1, u = !1, l = function () {
                                u || (s = !0, e._counter--)
                            };
                    ...
                    Object.defineProperty(t, "__esModule", {value: !0}), t.always = n
                }, function (e, t, r) {
                    "use strict";
                    function n() {
                        return s
                    ...
                    function o() {
                        ...
                        if (e && e.length >= 3) {
                            var t = parseInt(e[1], 10), r = parseInt(e[2], 10);
                            if (!isNaN(t) && !isNaN(r))return {major: t, minor: r}
                        }
                        return null
                    }
                    ...
                    Object.defineProperty(t, "__esModule", {value: !0});
                    var a = "undefined" != typeof navigator ? navigator.userAgent : "", s = !/chrome|opera/i.test(a) && /safari/i.test(a), u = a.indexOf("MSIE ") >= 0 || a.indexOf("Trident/") >= 0, l = /version\/(\d+)\.(\d+)/i;
                    ...
                    "use strict";
                    Object.defineProperty(t, "__esModule", {value: !0});
                    var n, o = r(25), i = r(11), a = r(26), s = r(12), u = r(4), l = r(0);
                    !function (e) {
                    ...
                    "use strict";
                    Object.defineProperty(t, "__esModule", {value: !0});
                    var n, o = r(1), i = r(13), a = r(29), s = r(16), u = r(5), l = r(27), c = r(6), d = r(17), p = r(14), h = r(28), f = r(15), _ = r(30);
                    !function (e) {
                    ...
                    var n = r(1), o = r(2), i = function () {
                        ...
                        return e.prototype.getResponse = function () {
                            ...
                            if (e instanceof Error)this._aborted = !0, this._responseDeferred.reject(e); else {
                    ...
                    Object.defineProperty(t, "__esModule", {value: !0});
                    var o = r(2), i = r(3), a = r(8), s = r(12), u = function (e) {
                        function t(t) {
                            var r = e.call(this, t) || this;
                    ...
                    Object.defineProperty(t, "__esModule", {value: !0});
                    var o = r(5), i = "undefined" != typeof window && "map"in window;
                    t.buildCache = n;
                    var a = function () {
                        function e() {
                            this._store = []
                        ...
                        return e.prototype.set = function (e, t) {
                            ...
                            r ? r.val = t : this._store.push({key: e, val: t})
                    ...
                    Object.defineProperty(t, "__esModule", {value: !0}), t.compact = n
                }, function (e, t, r) {
                    "use strict";
                    function n(e, r, n, o) {
                        void 0 === n && (n = window.setTimeout), void 0 === o && (o = window.clearTimeout);
                        var s = new i.AbortableJob(function () {
                            var i = a.buildDeferred(), s = 0, u = null, l = null, c = function () {
                                u = e(s).run(), u.onCompletion(function (e) {
                                    if (u = null, e.success)i.resolve(e.result); else {
                                        var o = r(++s);
                            ...
                            return c(), {
                                result: i.promise, abort: function () {
                                    u && u.abort(), l && o(l)
                                }
                            }
                        });
                    ...
                    function o(e) {
                        var t = void 0 === e ? {} : e, r = t.timeBase, n = void 0 === r ? 500 : r, o = t.threshold, i = void 0 === o ? 3 : o, a = t.delayCap, s = void 0 === a ? 45e3 : a, u = t.jitter, l = void 0 === u ? 200 : u, c = t.maxAttempts, d = void 0 === c ? null : c;
                    ...
                    var o = r(16), i = function () {
                        ...
                        return e.prototype.subscribe = function (e, t) {
                            ...
                            void 0 === t && (t = !0);
                            var o = function () {
                                var o = {callback: e, localState: t ? n(r._state) : r._initialState};
                    ...
                    !function (t) {
                        var r = /^((?:[^\/;?#]+:)?)(\/\/[^\/\;?#]*)?(.*?)??(;.*?)?(\?.*?)?(#.*?)?$/, n = /^([^\/;?#]*)(.*)$/, o = /(?:\/|^)\.(?=\/)/g, i = /(?:\/|^)\.\.\/(?!\.\.\/).*?(?=\/)/g, a = {
                            buildAbsoluteURL: function (e, t, r) {
                                ...
                                if (!i.netLoc && (l.netLoc = s.netLoc, "/" !== i.path[0]))if (i.path) {
                                    var c = s.path, d = c.substring(0, c.lastIndexOf("/") + 1) + i.path;
                    ...
                    "use strict";
                    Object.defineProperty(t, "__esModule", {value: !0}), t.version = "7.0.5", t.buildNumber = 790;
                    var n = r(2), o = r(21), i = r(3), a = r(22);
            ...
            !function (t, n) {
                ...
                return function (e) {
                    ...
                    Object.defineProperty(t, "__esModule", {value: !0});
                    var o = r(0), i = r(19), a = r(20), s = o.helpers.Promise, u = {
                        rate: 44100,
                        id: 3
                    }, l = 16, c = 2, d = u.rate, p = 2, h = 8;
                    t.MP3ToMP4 = {
                        getInputFormat: function () {
                            return {mimeType: "audio/mpeg", audioCodec: {id: "mp3"}}
                        }, getOutputFormat: function () {
                            return {mimeType: "audio/mp4", audioCodec: {id: "mp3"}}
                        }, transmux: function (e) {
                            return new s(function (t, r) {
                                ...
                                var f = !1;
                                try {
                                    var _ = [], g = new i.MP3Parser, y = new a.MP4Mux({
                                        audioTrackId: 0,
                                        videoTrackId: -1,
                                        tracks: [{
                                            codecId: p,
                                    ...
                                    if (y.ondata = function (e) {
                                            ...
                                            try {
                                                var t = new Uint8Array(e.length + 1), r = p << 4;
                                        ...
                                        }, g.push(e), g.close(), y.flush(), 0 === _.length)o(new Error("There was no output.")); else {
                                        var v = _.shift();
                                        v ? s({initData: v, data: n(_)}) : o(new Error("No init data."))
                                    }
                                } catch (e) {
                                    o(e)
                                }
                    ...
                    "use strict";
                    Object.defineProperty(t, "__esModule", {value: !0});
                    var n, o = r(5), i = r(6), a = r(2), s = r(7), u = r(8), l = r(9), c = r(10);
                    !function (e) {
                    ...
                    function o(e, t) {
                        void 0 === t && (t = {});
                        var r = e.mimeType || t.mimeType, n = e.audioCodec || t.audioCodec, o = e.videoCodec || t.videoCodec, i = P([n, o]), a = i.length > 0 ? '; codecs="' + i.map(function (e) {
                            return e.id
                        }).join(",") + '"' : "";
                        return r + a
                    }
                    ...
                    var a = r(0), s = r(4), u = r(35), l = r(14), c = r(28), d = r(32), p = r(30), h = r(29), f = r(10), _ = r(5), g = r(6), y = r(9), v = r(8), m = r(7), E = r(1), b = a.helpers.find, w = a.helpers.Promise, P = a.helpers.compact, S = a.helpers.time.now, R = a.helpers.deferred.buildDeferred, T = s.helpers.timeRanges.normalizeTimeRanges, A = a.errors.DependencyError, M = a.errors.PlayerFatalError, k = a.errors.URLUpdateError, x = a.eventDispatcher.EventDispatcher, D = a.logger.prefixLogger, O = a.helpers.abortableJob.abortedError, C = a.helpers.browser.getSafariVersion(), I = 3e4, L = 1e8, N = 400, j = function (e) {
                        ...
                        return i(t, e), t.prototype.getBufferedTimeRanges = function () {
                            ...
                            return c.MSE.isSupported() ? e.prototype._canPlay.call(this).then(function (e) {
                                ...
                                var a = i.getOutputFormat(), s = r;
                                return t._transmuxerAndMSEType = {transmuxer: i, mseType: o(a, s)}, w.resolve(!0)
                            ...
                            if (null === this._maxBufferLength)if (void 0 !== t.maxBufferLength) {
                            ...
                            if (this._logger.debug("Initialized max buffer length.", this._maxBufferLength), null === this._cacheSize)if (void 0 !== t.memoryCacheSize) {
                            ...
                            var n = this, o = this, i = o._simpleMSE, a = o._mse, s = this.getMediaElement();
                            ...
                            var r = new c.MSE(this._transmuxerAndMSEType.mseType, this._logger, t), n = new d.SimpleMSE(r, function () {
                            ...
                            var t = this, r = this._playlist;
                            if (!r)throw new Error("Playlist should have been retrieved.");
                            var n = !this._initialPlaylistRetrieveCompleted;
                            if (n)this._initialPlaylistRetrieveCompleted = !0, this._playlistDuration = r.getTotalDuration(), this._retrieveDurationDeferred.resolve(this._playlistDuration); else {
                            ...
                            if (!this._transmuxerAndMSEType)throw new Error("Transmuxer should have been configured.");
                            if (this._playlistSegmentRetriever)this._logger.debug("Switching playlist for playlist segment retriever."), this._playlistSegmentRetriever.switchPlaylist(r); else {
                                ...
                                s.onSegmentRequestQueued.subscribe(this._onSegmentRequestQueued.dispatch), s.onSegmentRequestStart.subscribe(this._onSegmentRequestStart.dispatch), s.onSegmentRetrieved.subscribe(this._onSegmentRetrieved.dispatch), s.onSegmentRequestFailed.subscribe(this._onSegmentRequestFailed.dispatch), s.onSegmentDecryptionStart.subscribe(this._onSegmentDecryptionStart.dispatch), s.onSegmentDecryptionEnd.subscribe(this._onSegmentDecryptionEnd.dispatch), s.onSegmentTransmuxStart.subscribe(this._onSegmentTransmuxStart.dispatch), s.onSegmentTransmuxEnd.subscribe(this._onSegmentTransmuxEnd.dispatch), this._playlistSegmentRetriever = s, s.onError.subscribe(function (e) {
                                    ...
                                    var r = e.eventRepresentation, n = S();
                                    t._logger.debug("Segment ready.", r), function () {
                                        var e = t._simpleMSE;
                                    ...
                                    }(), t._onSegmentReady.dispatch({segment: r}, {time: n})
                                })
                            }
                            ...
                            if (t) {
                                var r = e.getSegmentsWithData(), n = r[r.map(function (e) {
                                    return e.segment
                                }).indexOf(t) + 1];
                            ...
                            var o = this.getPosition(), n = b(e.getSegmentsWithData(), function (e) {
                                return e.segment.getTimeRange().containsTime(o)
                            });
                            if (!n)return this._logger.debug("No segment found."), null;
                            var i = o - n.segment.getTimeRange().start, a = this.getMediaElement();
                    ...
                    "use strict";
                    Object.defineProperty(t, "__esModule", {value: !0});
                    var n, o = r(11), i = r(12), a = r(1), s = r(3), u = r(13);
                    !function (e) {
                    ...
                    t.AESDecryptor = function () {
                        ...
                        return o(e, [{
                            ...
                            key: "initTable", value: function () {
                                var e = this.sBox, t = this.invSBox, r = this.subMix[0], n = this.subMix[1], o = this.subMix[2], i = this.subMix[3], a = this.invSubMix[0], s = this.invSubMix[1], u = this.invSubMix[2], l = this.invSubMix[3], c = new Uint32Array(256), d = 0, p = 0, h = 0;
                                for (h = 0; h < 256; h++)h < 128 ? c[h] = h << 1 : c[h] = h << 1 ^ 283;
                                for (h = 0; h < 256; h++) {
                                    var f = p ^ p << 1 ^ p << 2 ^ p << 3 ^ p << 4;
                                    f = f >>> 8 ^ 255 & f ^ 99, e[d] = f, t[f] = d;
                                    var _ = c[d], g = c[_], y = c[g], v = 257 * c[f] ^ 16843008 * f;
                            ...
                            key: "expandKey", value: function (e) {
                                ...
                                if (!r) {
                                    ...
                                    var i = this.ksRows = 4 * (o + 6 + 1), a = void 0, s = void 0, u = this.keySchedule = new Uint32Array(this.ksRows), l = this.invKeySchedule = new Uint32Array(this.ksRows), c = this.sBox, d = this.rcon, p = this.invSubMix[0], h = this.invSubMix[1], f = this.invSubMix[2], _ = this.invSubMix[3], g = void 0, y = void 0;
                    ...
                    var o = [32, 64, 96, 128, 160, 192, 224, 256, 288, 320, 352, 384, 416, 448, 32, 48, 56, 64, 80, 96, 112, 128, 160, 192, 224, 256, 320, 384, 32, 40, 48, 56, 64, 80, 96, 112, 128, 160, 192, 224, 256, 320, 32, 48, 56, 64, 80, 96, 112, 128, 144, 160, 176, 192, 224, 256, 8, 16, 24, 32, 40, 48, 56, 64, 80, 96, 112, 128, 144, 160], i = [44100, 48e3, 32e3, 22050, 24e3, 16e3, 11025, 12e3, 8e3];
                    n.prototype.push = function (e) {
                        ...
                        if (255 === e[t] || 224 === (224 & e[t + 1])) {
                            if (t + 24 > r)return -1;
                            var n = e[t + 1] >> 3 & 3, a = e[t + 1] >> 1 & 3, s = e[t + 2] >> 4 & 15, u = e[t + 2] >> 2 & 3, l = !!(2 & e[t + 2]);
                            if (1 !== n && 0 !== s && 15 !== s && 3 !== u) {
                                var c = 3 === n ? 3 - a : 3 === a ? 3 : 4, d = 1e3 * o[14 * c + s - 1], p = 3 === n ? 0 : 2 === n ? 1 : 2, h = i[3 * p + u], f = l ? 1 : 0, _ = 3 === a ? (3 === n ? 12 : 6) * d / h + f << 2 : (3 === n ? 144 : 72) * d / h + f | 0;
                    ...
                    !function (e) {
                        ...
                        !function (e) {
                            ...
                            function r(e) {
                                var t, r = 0, n = a.RAW, o = e[r], i = o >> 4, d = o >> 2 & 3, p = 2 & o ? 16 : 8, h = 1 & o ? 2 : 1;
                                switch (r++, i) {
                                    case c:
                                        var f = e[r++];
                                        n = f, t = 1024;
                            ...
                            function n(e) {
                                var t = 0, r = e[t] >> 4, n = 15 & e[t];
                                t++;
                                var o = {frameType: r, codecId: n, codecDescription: p[n]};
                                switch (n) {
                                    case f:
                                        var i = e[t++];
                            ...
                            function o(e) {
                                var t, r, n = [], o = -1, i = -1, a = +e.asGetPublicProperty("duration"), s = e.asGetPublicProperty("audiocodecid");
                                switch (s) {
                                    case l:
                                    case"mp3":
                                        t = "mp3", r = l;
                                ...
                                if (y)for (var v = 0; v < y.length; v++) {
                                    var m = y[v], E = m.asGetPublicProperty("sampledescription")[0];
                            ...
                            var a, s = [5500, 11025, 22050, 44100], u = ["PCM", "ADPCM", "MP3", "PCM le", "Nellymouser16", "Nellymouser8", "Nellymouser", "G.711 A-law", "G.711 mu-law", null, "AAC", "Speex", "MP3 8khz"], l = 2, c = 10;
                            !function (e) {
                                e[e.HEADER = 0] = "HEADER", e[e.RAW = 1] = "RAW"
                            }(a || (a = {}));
                            var d, p = [null, "JPEG", "Sorenson", "Screen", "VP6", "VP6 alpha", "Screen2", "AVC"], h = 4, f = 7;
                            !function (e) {
                                ...
                                return o.prototype.pushPacket = function (e, t, o) {
                                    ...
                                    if (r) {
                                        for (var n = ["isom"], o = 1, i = 1, a = [], s = 0; s < this.trackStates.length; s++) {
                                            var u, d = this.trackStates[s], p = d.trackInfo;
                                            switch (p.codecId) {
                                                case c:
                                    ...
                                    if (0 !== t.length) {
                                        for (var o = [], i = 0, a = [], s = [], u = 0; u < this.trackStates.length; u++) {
                                            var p = this.trackStates[u], _ = p.trackInfo, g = p.trackId, y = t.filter(function (e) {
                                                return e.trackId === g
                                            });
                                            if (0 !== y.length) {
                                                ...
                                                switch (s.push(i), _.codecId) {
                                                    ...
                                                    case l:
                                                        ...
                                                        for (var r = 0; r < y.length; r++) {
                                                            var P = y[r].packet, S = Math.round(P.samples * _.timescale / _.samplerate);
                                                    ...
                                                    case h:
                                                        ...
                                                        for (var A = p.samplesProcessed, M = A * _.timescale / _.framerate, k = Math.round(M), r = 0; r < y.length; r++) {
                                                            var x = y[r].packet;
                                                            A++;
                                                            var D = Math.round(A * _.timescale / _.framerate), O = D - k;
                                                            k = D;
                        ...
                        !function (e) {
                            ...
                            !function (e) {
                                ...
                                var d = o.StringUtilities.utf8decode, p = -20828448e5, h = [1, 0, 0, 0, 1, 0, 0, 0, 1], f = [0, 0, 0], _ = function () {
                                    function e(e, t) {
                                    ...
                                    return e.prototype.layout = function (e) {
                                        ...
                                        var e = this.layout(0), t = new Uint8Array(e);
                                ...
                                var y = function (e) {
                                    ...
                                    return i(t, e), t.prototype.layout = function (t) {
                                        ...
                                        var o = this, i = e.prototype.write.call(this, t);
                                ...
                                var B = function (e) {
                                    ...
                                    return i(t, e), t.prototype.layout = function (t) {
                                        var r = e.prototype.layout.call(this, t) + 4, n = this.flags;
                                        ...
                                        var n = e.prototype.write.call(this, t), o = this.flags;
                                ...
                                var V = function (e) {
                                    ...
                                    return i(t, e), t.prototype.layout = function (t) {
                                        var r = e.prototype.layout.call(this, t) + 4, n = this.samples.length, o = this.flags;
                                        ...
                                        var n = e.prototype.write.call(this, t), o = this.samples.length, i = this.flags;
                                ...
                                var J = function (e) {
                                    ...
                                    return i(t, e), t.prototype.layout = function (t) {
                                        ...
                                        var r = this, n = e.prototype.write.call(this, t);
                                        return this.chunks.forEach(function (e) {
                    ...
                    "use strict";
                    Object.defineProperty(t, "__esModule", {value: !0});
                    var n = r(24), o = r(23), i = [n.WebCrypto, o.JSCrypto];
                    t.default = i
                }, function (e, t, r) {
                    "use strict";
                    Object.defineProperty(t, "__esModule", {value: !0});
                    var n = r(0), o = r(21), i = n.helpers.find;
                    t.DecryptorFactory = {
                    ...
                    "use strict";
                    Object.defineProperty(t, "__esModule", {value: !0});
                    var n = r(0), o = r(18), i = n.helpers.Promise, a = null;
                    t.JSCrypto = {
                    ...
                    "use strict";
                    Object.defineProperty(t, "__esModule", {value: !0});
                    var n = r(0), o = n.helpers.Promise, i = window.crypto && window.crypto.subtle;
                    t.WebCrypto = {
                        canDecrypt: function (e) {
                            ...
                            return new o(function (r, n) {
                                function o(e) {
                                    return i.importKey("raw", e, {name: "AES-CBC"}, !1, ["decrypt"])
                                }

                                o(t.key).then(function (r) {
                                    return i.decrypt({name: "AES-CBC", iv: t.iv}, r, e)
                                }).then(function (e) {
                    ...
                    "use strict";
                    Object.defineProperty(t, "__esModule", {value: !0});
                    var n = r(0), o = r(4), i = n.helpers.deferred.buildDeferred, a = o.helpers.timeRanges.buildTimeRanges, s = n.helpers.Promise, u = o.helpers.timeRanges.getCoverage, l = n.logger.prefixLogger, c = n.logger.noOpLogger, d = /(MSIE )|(Trident\/)/, p = n.helpers.browser.isSafari(), h = 'audio/mp4; codecs="mp3"', f = n.helpers.browser.getSafariVersion();
                    ...
                    "use strict";
                    Object.defineProperty(t, "__esModule", {value: !0});
                    var n, o = r(0), i = o.helpers.find, a = o.eventDispatcher.EventDispatcher, s = o.helpers.abortableJob.abortedError, u = o.helpers.abortableJob.AbortableJob, l = o.logger.prefixLogger, c = o.logger.noOpLogger;
                    !function (e) {
                    ...
                    var d = function () {
                        function e(e) {
                            ...
                            var t = e.playlist, r = e.getPosition, n = e.maxBufferLength, o = e.cacheSize, i = e.transmuxer, s = e.logger, u = void 0 === s ? c : s;
                        ...
                        return e.prototype.updateMaxBufferLength = function (e) {
                            ...
                            return this._ensureNotDead(), this._segments.filter(function (e) {
                                ...
                                var t = e.segment, r = e.initData, o = e.data, i = e.eventRepresentation;
                                return {segment: t, initData: r, data: o, eventRepresentation: i}
                            })
                            ...
                            if (!r || r.state !== n.RETRIEVING_DATA || e.segment !== r.segment) {
                                ...
                                var o = new u(function () {
                                    var r = !1, n = e.segment.retrieveData();
                                    t._logger.debug("Retrieving segment data...");
                                    var o = n.whenComplete().then(function (e) {
                                        var n = e.data, o = e.eventRepresentation;
                                        if (r)throw s;
                                        return t._logger.debug("Retrieved segment data."), t._onSegmentTransmuxStart.dispatch({segment: o}), t._transmuxer.transmux(n).then(function (e) {
                                            var n = e.data, i = e.initData;
                                            if (r)throw s;
                                            return t._onSegmentTransmuxEnd.dispatch({segment: o}), t._logger.debug("Transmuxed segment."), {
                                                data: n,
                                                initData: i,
                                    ...
                                    return {
                                        result: o, abort: function () {
                                            r = !0, n.abort()
                                        }
                                    }
                                }).run();
                                o.onCompletion(function (r) {
                                    var o = r.initData, i = r.data, a = r.eventRepresentation;
                            ...
                            var t = this, r = this._retrievingSegment, o = this._playlist, i = o ? o.getSegmentIndexContainingTime(e) : null;
                            if (!r || r.state !== n.RETRIEVING_SEGMENT || r.segmentIndex !== i)if (this._abortCurrentRetrieve(), null !== i && o) {
                                ...
                                this._logger.debug("Retrieving segment.", i), a.onCompletion(function (e) {
                                    ...
                                    var r = e.getTimeRange(), o = t._segments.length;
                                ...
                                var u = {state: n.RETRIEVING_SEGMENT, segmentIndex: i, segmentRetrieveJob: a};
                            ...
                            var t = this._segments, r = this._cacheSize, o = this.getCacheUsage();
                            if (!(o <= r)) {
                                ...
                                t.filter(function (t) {
                                    ...
                                    var r = t.segment.getTimeRange(), o = Math.abs(e - r.start);
                                    return {segment: t, distance: o, size: t.data.byteLength}
                                }).sort(function (e, t) {
                    ...
                    var D = function () {
                        function e(e) {
                            var t = e.url, r = e.playlistLoader, n = e.segmentLoader, o = e.keyLoader, i = void 0 === o ? null : o, s = e.segmentFormat, u = e.logger, l = void 0 === u ? T : u, d = e.delayCalculator, p = void 0 === d ? E() : d, f = e.keyDelayCalculator, v = void 0 === f ? E() : f, w = e.segmentDelayCalculator, P = e.isPlaylistResponseCodeAcceptable, A = void 0 === P ? function (e) {
                                return 200 === e
                            } : P, M = e.isPlaylistResponseCodeRetryable, k = void 0 === M ? a : M, x = e.isSegmentResponseCodeAcceptable, D = void 0 === x ? function (e) {
                                return 200 === e
                            } : x, O = e.isSegmentResponseCodeRetryable, C = void 0 === O ? a : O, I = e.isKeyResponseCodeAcceptable, L = void 0 === I ? function (e) {
                                return 200 === e
                            } : I, N = e.isKeyResponseCodeRetryable, j = void 0 === N ? a : N, F = this;
                            this._keyRetrievalJobsCache = y(), this._data = null, this._playlistEventRepresentation = null, this._onPlaylistRequestQueued = new S, this._onPlaylistRequestStart = new S, this._onPlaylistRetrieved = new S, this._onPlaylistRequestFailed = new S, this._onPlaylistParseStart = new S, this._onPlaylistParseEnd = new S, this._onKeyRequestQueued = new S, this._onKeyRequestStart = new S, this._onKeyRetrieved = new S, this._onKeyRequestFailed = new S, this._logger = R(l, "Playlist"), this.onPlaylistRequestQueued = this._onPlaylistRequestQueued.getHandle(), this.onPlaylistRequestStart = this._onPlaylistRequestStart.getHandle(), this.onPlaylistRetrieved = this._onPlaylistRetrieved.getHandle(), this.onPlaylistRequestFailed = this._onPlaylistRequestFailed.getHandle(), this.onPlaylistParseStart = this._onPlaylistParseStart.getHandle(), this.onPlaylistParseEnd = this._onPlaylistParseEnd.getHandle(), this.onKeyRequestQueued = this._onKeyRequestQueued.getHandle(), this.onKeyRequestStart = this._onKeyRequestStart.getHandle(), this.onKeyRetrieved = this._onKeyRetrieved.getHandle(), this.onKeyRequestFailed = this._onKeyRequestFailed.getHandle(), this._url = t, this._playlistLoader = r, this._segmentLoader = n, this._keyLoader = i, this._segmentFormat = s, this._delayCalculator = p, this._keyDelayCalculator = v, this._isPlaylistResponseCodeAcceptable = A, this._isPlaylistResponseCodeRetryable = k, this._isSegmentResponseCodeAcceptable = D, this._isSegmentResponseCodeRetryable = C, this._isKeyResponseCodeAcceptable = L, this._isKeyResponseCodeRetryable = j, this._segmentDelayCalculator = w, this._downloadAbortableJob = new _(function () {
                                var e = m(function () {
                                    return new _(function () {
                                        ...
                                        F._onPlaylistRequestQueued.dispatch({playlist: e});
                                        var r = F._playlistLoader.request({url: t});
                                        r.whenRequestStarted.then(function () {
                                            F._onPlaylistRequestStart.dispatch({playlist: e})
                                        ...
                                        var n = r.getResponse().then(function (r) {
                                            ...
                                            if (F._isPlaylistResponseCodeAcceptable(n)) {
                                                ...
                                                return o ? (F._logger.debug("Got playlist response.", t, n), F._onPlaylistRetrieved.dispatch({
                                                    ...
                                                    success: !0,
                                                    result: {playlistContent: o, eventRepresentation: e}
                                            ...
                                            return F._isPlaylistResponseCodeRetryable(n) ? (F._logger.debug("Playlist response code was not acceptable. Will retry.", t, n), F._onPlaylistRequestFailed.dispatch({
                                                playlist: e,
                                                statusCode: n
                                            }), {success: !1}) : (F._logger.debug("Playlist response code was not acceptable.", t, n), F._onPlaylistRequestFailed.dispatch({
                                                playlist: e,
                                                statusCode: n
                                            }), b.reject(new c.UnacceptableResponseStatusCodeError(n)))
                                        });
                                        return {
                                            result: n, abort: function () {
                                ...
                                return {
                                    result: e.whenComplete(), abort: function () {
                                        return e.abort()
                                    }
                                }
                            }), this._retrieveJob = new _(function () {
                                var e = F._downloadAbortableJob.run(), t = g();
                                return e.onCompletion(function (e) {
                                    var r = e.playlistContent, n = e.eventRepresentation;
                                    F._onPlaylistParseStart.dispatch({playlist: n});
                                    try {
                                        F._data = F._parsePlaylist(r)
                                    } catch (e) {
                                        return F._logger.error("Error when parsing playlist.", e, r), void t.reject(e)
                                    }
                                    F._playlistEventRepresentation = n, F._onPlaylistParseEnd.dispatch({playlist: n}), t.resolve(void 0)
                                }), e.onError(t.reject), {
                                    result: t.promise, abort: function () {
                                        return e.abort()
                                    }
                                }
                            })
                        ...
                        return e.prototype.retrieve = function () {
                            ...
                            return n.segments.slice(e - o, t - o).map(function (t, n) {
                                var o = new _(function () {
                                    var o = t.encryptionData, i = e + n, a = r._playlistEventRepresentation;
                                    if (!a)throw new Error("Playlist event representation should exist.");
                                    var s = r._buildEncryptionConfig(o, i), u = s.whenComplete().then(function (e) {
                            ...
                            var r = this, n = new _(function () {
                                if (e.method === s.NONE)return {result: b.resolve(void 0)};
                                if (e.method !== s.AES_128)return r._logger.error("Unsupported encryption method.", e.method), {result: b.reject(new p.UnsupportedEncryptionError)};
                                var n = r._keyLoader;
                                if (!n)return {result: b.reject(new Error("Encryption method not supported as no key loader provided."))};
                                var o = r._retrieveKey(e.keyUrl), a = o.whenComplete().then(function (r) {
                                    return {cipher: "AES-CBC", key: r, iv: e.iv || i(t)}
                                });
                                return {
                                    result: a, abort: function () {
                                        return o.abort()
                                    }
                                }
                            });
                            ...
                            var t = this, r = this._keyLoader;
                            if (!r)throw new Error("No key loader.");
                            var n = this._keyRetrievalJobsCache.get(e);
                            if (n)this._logger.debug("Key retrieval already in progress.", e); else {
                                ...
                                n = new _(function () {
                                    var n = m(function () {
                                        return new _(function () {
                                            var n = new f.Key(o, e);
                                            t._onKeyRequestQueued.dispatch({key: n});
                                            var i = r.request({url: e});
                                            i.whenRequestStarted.then(function () {
                                                return t._onKeyRequestStart.dispatch({key: n})
                                            ...
                                            var a = i.getResponse().then(function (r) {
                                                ...
                                                return t._isKeyResponseCodeRetryable(o) ? (t._logger.warn("Key response code was not acceptable. Will retry.", e, o), t._onKeyRequestFailed.dispatch({
                                                    key: n,
                                                    statusCode: o
                                                }), {success: !1}) : (t._logger.warn("Key response code was not acceptable.", e, o), t._onKeyRequestFailed.dispatch({
                                                    key: n,
                                                    statusCode: o
                                    ...
                                    return {
                                        result: n.whenComplete(), abort: function () {
                                            return n.abort()
                                        }
                                    }
                                    ...
                                    if (p)switch (f) {
                                        case"key":
                                            ...
                                            for (var m = void 0, E = null, b = null, w = null; null !== (m = M.exec(_[0]));) {
                                                ...
                                                var S = m[1].trim().toLowerCase(), R = n(m[2].trim());
                                                switch (S) {
                                                    case"method":
                                                        E = R.toLowerCase();
                                                        break;
                                            ...
                                            switch (E) {
                                                ...
                                                case"aes-128":
                                                    ...
                                                    i = {method: s.AES_128, keyUrl: b, iv: w};
                                                    break;
                                                case"sample-aes":
                                                    if (!b)throw new d.PlaylistParseError("Key url required.");
                                                    i = {method: s.SAMPLE_AES, keyUrl: b, iv: w};
                                                    break;
                                                default:
                            ...
                            var D = t.version, O = t.type, C = t.mediaSequence, I = t.targetDuration, L = t.ended, N = t.totalDuration;
                    ...
                    "use strict";
                    Object.defineProperty(t, "__esModule", {value: !0});
                    var n = r(0), o = r(22), i = r(3), a = r(11), s = r(27), u = n.helpers.abortableJob.AbortableJob, l = n.helpers.retry, c = l.retry, d = l.buildExponentialDelayCalculator, p = n.helpers.Promise, h = n.eventDispatcher.EventDispatcher, f = n.logger.prefixLogger, _ = n.logger.noOpLogger, g = function () {
                        function e(e) {
                            var t = e.url, r = e.index, n = e.timeRange, o = e.encryptionConfig, a = e.format, l = e.loader, g = e.playlistEventRepresentation, y = e.logger, v = void 0 === y ? _ : y, m = e.delayCalculator, E = void 0 === m ? d() : m, b = e.isResponseCodeAcceptable, w = void 0 === b ? function (e) {
                                return 200 === e
                            } : b, P = e.isResponseCodeRetryable, S = void 0 === P ? function (e) {
                                return !(e >= 400 && e < 500)
                            } : P, R = this;
                            this._onSegmentRequestQueued = new h, this._onSegmentRequestStart = new h, this._onSegmentRetrieved = new h, this._onSegmentRequestFailed = new h, this._onSegmentDecryptionStart = new h, this._onSegmentDecryptionEnd = new h, this._logger = f(v, "Segment"), this.onSegmentRequestQueued = this._onSegmentRequestQueued.getHandle(), this.onSegmentRequestStart = this._onSegmentRequestStart.getHandle(), this.onSegmentRetrieved = this._onSegmentRetrieved.getHandle(), this.onSegmentRequestFailed = this._onSegmentRequestFailed.getHandle(), this.onSegmentDecryptionStart = this._onSegmentDecryptionStart.getHandle(), this.onSegmentDecryptionEnd = this._onSegmentDecryptionEnd.getHandle(), this._timeRange = n, this._encryptionConfig = o || null, this._format = a, this._loader = l, this._isResponseCodeAcceptable = w, this._isResponseCodeRetryable = S, this._downloadAbortableJob = new u(function () {
                                var e = c(function () {
                                    return new u(function () {
                                        ...
                                        R._onSegmentRequestQueued.dispatch({segment: e});
                                        var n = R._loader.request({url: t});
                                        n.whenRequestStarted.then(function () {
                                            return R._onSegmentRequestStart.dispatch({segment: e})
                                        ...
                                        var o = n.getResponse().then(function (r) {
                                            ...
                                            if (R._isResponseCodeAcceptable(n)) {
                                                ...
                                                return o ? (R._logger.debug("Got segment response.", t, n), R._onSegmentRetrieved.dispatch({
                                                    ...
                                                    success: !0,
                                                    result: {data: new Uint8Array(o), eventRepresentation: e}
                                            ...
                                            return R._isResponseCodeRetryable(n) ? (R._logger.debug("Segment response code was not acceptable. Will retry.", t, n), R._onSegmentRequestFailed.dispatch({
                                                segment: e,
                                                statusCode: n
                                            }), {success: !1}) : (R._logger.debug("Segment response code was not acceptable.", t, n), R._onSegmentRequestFailed.dispatch({
                                                segment: e,
                                                statusCode: n
                                ...
                                var e = R._downloadAbortableJob.run(), t = e.whenComplete().then(function (e) {
                                    var t = e.data, r = e.eventRepresentation;
                                    return R.decrypt(t, r).then(function (e) {
                                        return {data: e, eventRepresentation: r}
                                    })
                                });
                                return {
                                    result: t, abort: function () {
                        ...
                        return e.prototype.getTimeRange = function () {
                            ...
                            var r = this, n = this._encryptionConfig;
                            ...
                            return s.then(function () {
                                r._logger.debug("Decrypted."), r._onSegmentDecryptionEnd.dispatch({segment: t})
                            }), s
                        }, e
                    }();
                    t.Segment = g
                    ...
                    "use strict";
                    Object.defineProperty(t, "__esModule", {value: !0});
                    var n = r(0), o = r(4), i = n.helpers.Promise, a = n.eventDispatcher.EventDispatcher, s = n.logger.prefixLogger, u = n.logger.noOpLogger, l = o.helpers.timeRanges.getCoverage, c = 7e3, d = function () {
                        ...
                        return e.prototype.start = function () {
                            ...
                            var r = this._mse;
                            this._onAppendQueued.dispatch({segment: e.eventRepresentation}), this._logger.debug("Appending..."), r.append(e.data).then(function () {
                                t._logger.debug("Appended."), t._onAppendEnd.dispatch({segment: e.eventRepresentation}), t._resettingPromise || t._scheduleUpdate()
                            }).catch(function (e) {
                    ...
                    "use strict";
                    Object.defineProperty(t, "__esModule", {value: !0});
                    var n = r(34), o = r(14), i = [n.PassThrough, o.MP3ToMP4];
                    t.default = i
                }, function (e, t, r) {
                    "use strict";
                    Object.defineProperty(t, "__esModule", {value: !0});
                    var n = r(0), o = n.helpers.Promise;
                    t.PassThrough = {
                        getInputFormat: function () {
                            return {}
                        }, getOutputFormat: function () {
                    ...
                    t.TransmuxerFactory = {
                        retrieveTransmuxers: function (e, t) {
                            return n.default.filter(function (r) {
                                var n = r.getInputFormat(), o = r.getOutputFormat();
                ...
                return function (e) {
                    ...
                    var i = r(0), a = r(1), s = r(2), u = r(3), l = r(7), c = i.helpers.deferred.buildDeferred, d = i.helpers.url.getExtension, p = i.helpers.Promise, h = i.logger.prefixLogger, f = i.errors.NotSupportedError, _ = i.errors.PlayerFatalError, g = new Error("Media element was revoked."), y = function (e) {
                        ...
                        return o(t, e), t.inferMimeType = function (e) {
                            ...
                            this._mediaElementAndState = {element: e, state: "INITIALIZING"};
                            var n = function () {
                            ...
                            }, {earlyAttach: !0}), this._listenTo("playing", function () {
                            ...
                            if (this._mediaElementAndState && "USABLE" === this._mediaElementAndState.state) {
                                ...
                                } else this._playInProgress = {inProgress: !1}, r.pause(), this._notifyPlaying(!1); else this._playInProgress.inProgress || this._notifyPlaying(e)
                            }
                        }, t.prototype._handleSeekChange = function (e) {
                            var t = this, r = this._mediaElementAndState;
                            ...
                            var r = this, n = this._mediaElementAndState;
                            ...
                            this._currentSeekCallback = {listenerHandle: i, callback: t}
                        }, t.prototype._getPosition = function () {
                            ...
                            void 0 === r && (r = {});
                            var n = r.reattach, o = r.earlyAttach;
                            void 0 === n && (n = !1), void 0 === o && (o = !1);
                            var i = function (e) {
                                a.remove(), t(e)
                            }, a = this._listenTo(e, i, {reattach: n, earlyAttach: o});
                            return a
                        }, t.prototype._listenTo = function (e, t, r) {
                            var n = this;
                            void 0 === r && (r = {});
                            var o = r.reattach, i = r.earlyAttach;
                            void 0 === o && (o = !0), void 0 === i && (i = !1);
                            var a = {attached: !1, handler: t, eventType: e, once: !1, reattach: o, earlyAttach: i};
                            ...
                            var e = this._mediaElementAndState, t = e.element, r = e.state;
            ...
            !function (t, n) {
                ...
                return function (e) {
                    ...
                    var o = r(5), i = function (e) {
                        ...
                        return n(t, e), t.prototype._abort = function () {
                            ...
                            for (var r = e.split("\r\n"), n = 0, o = r.length; n < o; n++) {
                                var i = r[n], a = i.indexOf(": ");
                                if (a > 0) {
                                    var s = i.substring(0, a).trim(), u = i.substring(a + 2);
                                    t[s] = u
                                }
                            }
                            return t
                    ...
                    t.arrayBufferLoader = {
                        request: function (e) {
                            var t = e.url, r = e.headers, o = e.timeout;
            ...
            !function (t, n) {
                ...
                return function (e) {
                    ...
                    Object.defineProperty(t, "__esModule", {value: !0});
                    var o = r(2), i = r(3), a = r(1), s = o.helpers.abortableJob.AbortableJob, u = o.helpers.find, l = o.helpers.time, c = 300, d = new a.Limiter(c, 3e5), p = 5e3, h = [i.renditions.encryptedHlsMp3, i.renditions.hlsMp3, i.renditions.httpMp3], f = function (e) {
                        function t(t) {
                            var r = t.loader, n = t.clientId, o = t.trackId, i = t.secretToken, a = void 0 === i ? null : i, s = t.requestAuthorization, u = void 0 === s ? null : s, l = t.excludedRenditions, c = void 0 === l ? [] : l, d = t.maxBitrate, p = void 0 === d ? 1 / 0 : d, h = t.endpointBaseUrl, f = void 0 === h ? "https://api.soundcloud.com/" : h, _ = t.encryptedStreamsEnabled, g = void 0 !== _ && _, y = e.call(this) || this;
                        ...
                        return n(t, e), t.prototype.getTrackId = function () {
                            ...
                            var e = this, t = this._maxBitrate, r = this._excludedRenditions, n = new s(function () {
                                ...
                                var n = e._getUrls(), o = n.whenComplete().then(function (e) {
                                    var n = e.urls, o = e.timeRetrieved, i = null;
                                    return h.filter(function (e) {
                                        ...
                                        var r = n.filter(function (t) {
                                            ...
                                            return {url: e.url, bitrate: e.bitrate}
                            ...
                            return this._getUrlsJob || (this._getUrlsJob = new s(function () {
                                var t = o.helpers.deferred.buildDeferred(), r = null, n = d.execute(function () {
                                    var n = e._requestAuthorization ? {Authorization: e._requestAuthorization} : {}, o = e._endpointBaseUrl + "i1/tracks/" + encodeURI(e._trackId + "") + "/streams?client_id=" + encodeURIComponent(e._clientId);
                                    ...
                                    var a = r.getResponse().then(function (e) {
                                        ...
                                        var t = l.now(), r = JSON.parse(e.data), n = [];
                                        return Object.keys(r).map(function (e) {
                                            var t = e.split("_"), o = t[0], i = t[1], a = t[2], s = parseInt(a, 10);
                                            if (o && i && !isNaN(s)) {
                                                var l = u(h, function (e) {
                                                    return e.scProtocol === o && e.scFormat === i
                                                });
                                                l && n.push({rendition: l, bitrate: s, url: r[e]})
                                            }
                                        }), {urls: n, timeRetrieved: t}
                                    });
         ...
         */
            (function () {
                ...
                function p() {
                    var t = e.nextTick, r = e.versions.node.match(/^(?:(\d+)\.)?(?:(\d+)\.)?(\*|\d+)$/);
                    return Array.isArray(r) && "0" === r[1] && "10" === r[2] && (t = o), function () {
                        t(y)
                    }
                }
                ...
                function f() {
                    var e = 0, t = new te(y), r = document.createTextNode("");
                    return t.observe(r, {characterData: !0}), function () {
                        r.data = e = ++e % 2
                    }
                }
                ...
                function T(e, t) {
                    if (t.constructor === e.constructor)R(e, t); else {
                        var r = w(t);
                ...
                var J, W, Y, Q = K, X = 0, Z = ({}.toString, function (e, t) {
                    oe[X] = e, oe[X + 1] = t, X += 2, 2 === X && (W ? W(y) : Y())
                }), $ = "undefined" != typeof window ? window : void 0, ee = $ || {}, te = ee.MutationObserver || ee.WebKitMutationObserver, re = "undefined" != typeof e && "[object process]" === {}.toString.call(e), ne = "undefined" != typeof Uint8ClampedArray && "undefined" != typeof importScripts && "undefined" != typeof MessageChannel, oe = new Array(1e3);
                Y = re ? p() : te ? f() : ne ? _() : void 0 === $ ? v() : g();
                var ie = void 0, ae = 1, se = 2, ue = new C, le = new C;
                ...
                var de = F, pe = U, he = B, fe = q, _e = 0, ge = G;
                G.all = de, G.race = pe, G.resolve = he, G.reject = fe, G._setScheduler = c, G._setAsap = d, G._asap = Z, G.prototype = {
                    ...
                    then: function (e, t) {
                        ...
                        var o = new this.constructor(m), i = r._result;
                        if (n) {
                            var a = arguments[n - 1];
                            Z(function () {
                                L(n, o, a, i)
                ...
                var ye = V, ve = {Promise: ge, polyfill: ye};
                r(23).amd ? (n = function () {
                    return ve
        ...
        (function (t) {
            "use strict";
            var n = r(3), o = r(20), i = r(2).Promise, a = function (e, r, n, o) {
                var a = void 0, s = new i(function (i) {
                    ...
                    a = new XMLHttpRequest, a.upload && a.upload.addEventListener("progress", o), a.open(e, r, !0), s || a.setRequestHeader("Content-Type", "application/x-www-form-urlencoded"), a.onreadystatechange = function () {
                        4 === a.readyState && i({responseText: a.responseText, request: a})
                    }, a.send(n)
                });
                return s.request = a, s
            }, s = function (e) {
                var t = e.responseText, r = e.request, n = void 0, o = void 0;
                try {
                    o = JSON.parse(t)
                } catch (e) {
                }
                return o ? o.errors && (n = {message: ""}, o.errors[0] && o.errors[0].error_message && (n = {message: o.errors[0].error_message})) : n = r ? {message: "HTTP Error: " + r.status} : {message: "Unknown error"}, n && (n.status = r.status), {
                    json: o,
                    error: n
                }
            }, u = function e(t, r, n, o) {
                var i = a(t, r, n, o), u = i.then(function (t) {
                    var r = t.responseText, n = t.request, o = s({responseText: r, request: n});
            ...
            e.exports = {
                request: function (e, r) {
                    var i = arguments.length <= 2 || void 0 === arguments[2] ? {} : arguments[2], a = arguments.length <= 3 || void 0 === arguments[3] ? function () {
                    } : arguments[3], s = n.get("oauth_token"), c = n.get("client_id"), d = {}, p = t.FormData && i instanceof FormData, h = void 0, f = void 0;
                    return d.format = "json", s ? d.oauth_token = s : d.client_id = c, l(i, d, p), "GET" !== e && (h = p ? i : o.encode(i), i = {oauth_token: s}), r = "/" !== r[0] ? "/" + r : r, f = "" + n.get("baseURL") + r + "?" + o.encode(i), u(e, f, h, a)
                }, oEmbed: function (e) {
                    var t = arguments.length <= 1 || void 0 === arguments[1] ? {} : arguments[1], r = t.element;
                    ...
                    var e = arguments.length <= 0 || void 0 === arguments[0] ? {} : arguments[0], t = e.asset_data || e.file, r = n.get("oauth_token") && e.title && t;
                    ...
                    var o = Object.keys(e), a = new FormData;
                    return o.forEach(function (t) {
                        var r = e[t];
                        "file" === t && (t = "asset_data", r = e.file), a.append("track[" + t + "]", r)
                    }), this.request("POST", "/tracks", a, e.progress)
                }, resolve: function (e) {
                    return this.request("GET", "/resolve", {url: e, _status_code_map: {302: 200}})
                }
            }
        }).call(t, function () {
            return this
        ...
        t.extract = function (e) {
            ...
            return "string" != typeof e ? {} : (e = e.trim().replace(/^(\?|#|&)/, ""), e ? e.split("&").reduce(function (e, t) {
                var r = t.replace(/\+/g, " ").split("="), n = r.shift(), o = r.length > 0 ? r.join("=") : void 0;
        ...
        "use strict";
        var n = r(3), o = r(11), i = r(2).Promise, a = function (e) {
            return n.set("oauth_token", e.oauth_token), e
        };
        e.exports = function () {
            var e = arguments.length <= 0 || void 0 === arguments[0] ? {} : arguments[0], t = n.get("oauth_token");
        ...
        var o = function () {
        ...
        }(), i = r(10), a = r(5), s = r(12), u = r(7), l = "SoundCloud_Dialog", c = function () {
            ...
            return o(e, [{
                ...
                key: "handleConnectResponse", value: function (e) {
                    var t = e.error;
        ...
        "use strict";
        var n = r(19), o = r(1).MaestroCore, i = o.errors.PlayerFatalError, a = o.State, s = r(1).SCAudio.errors, u = s.GeoBlockedError, l = s.NoStreamsError, c = s.TimedOutError, d = s.NotSupportedError, p = 1e3 / 60;
        e.exports = function (e) {
            function t() {
                switch (e.getState()) {
                    case a.PLAYING:
            ...
            function r() {
                ...
                e.onChange.subscribe(function (e) {
                    var n = e.playing, o = e.seeking, i = e.dead;
        ...
        (function (t) {
            "use strict";
            var r = t.AudioContext || t.webkitAudioContext, n = null;
            e.exports = function () {
                return n ? n : n = new r
            }
        }).call(t, function () {
        ...
        }(), i = r(14), a = r(15), s = r(2).Promise, u = r(28), l = function () {
            var e = this, t = this.context;
            return new s(function (r, n) {
                e.source ? e.source instanceof AudioNode ? r(e.source) : n(new Error("source needs to be an instance of AudioNode")) : a({audio: !0}, function (n) {
                ...
                key: "getBuffer", value: function () {
                    ...
                    return new s(function (t, r) {
                        e._recorder ? e._recorder.getBuffer(function (r) {
                            var n = e.context.sampleRate, o = e.context.createBuffer(2, r[0].length, n);
        ...
        "use strict";
        var n = r(4), o = r(3), i = r(13), a = r(1).SCAudio, s = r(1).SCAudioPublicApiStreamURLRetriever.StreamUrlRetriever, u = r(1).MaestroHTML5Player.HTML5Player, l = r(1).MaestroHLSMSEPlayer.HLSMSEPlayer, c = r(1).MaestroLoaders.stringLoader, d = 3e3;
        e.exports = function (e, t) {
            var r = t ? {secret_token: t} : {};
            return n.request("GET", e, r).then(function (e) {
                ...
                var n = o.get("baseURL"), p = o.get("client_id"), h = o.get("oauth_token"), f = !1, _ = new s({
                    clientId: p,
                    secretToken: t,
                    trackId: e.id,
        ...
        !function () {
            function r() {
                return {
                    keys: Object.keys || function (e) {
                        ...
                        if (null != e)if (o && e.forEach === o)e.forEach(t, r); else if (e.length === +e.length)for (var n = 0, i = e.length; n < i; n++)t.call(r, e[n], n, e); else for (var a in e)this.has(e, a) && t.call(r, e[a], a, e)
                    }, once: function (e) {
                        var t, r = !1;
                        return function () {
            ...
            var n, o = Array.prototype.forEach, i = Object.prototype.hasOwnProperty, a = Array.prototype.slice, s = 0, u = r();
            n = {
                on: function (e, t, r) {
                    ...
                    for (a = e ? [e] : u.keys(this._events), s = 0, l = a.length; s < l; s++)if (e = a[s], i = this._events[e]) {
                        if (this._events[e] = n = [], t || r)for (d = 0, p = i.length; d < p; d++)o = i[d], (t && t !== o.callback && t !== o.callback._callback || r && r !== o.context) && n.push(o);
            ...
            var l = /\s+/, c = function (e, t, r, n) {
                ...
                var r, n = -1, o = e.length, i = t[0], a = t[1], s = t[2];
                switch (t.length) {
                    case 0:
            ...
            u.each(p, function (e, t) {
                n[t] = function (t, r, n) {
                    var o = this._listeners || (this._listeners = {}), i = t._listenerId || (t._listenerId = u.uniqueId("l"));
        ...
        e.exports = {
            encode: function (e, t) {
                ...
                function a(e, t) {
                    var r = /%20/g, n = encodeURIComponent, a = typeof t, s = null;
                ...
                var l = "object" == typeof t ? t : {}, c = l.ignorenull || !1, d = l.sorted || !1;
        ...
        (function (e, t) {
            !function (e, r) {
                ...
                if (!e.setImmediate) {
                    var h, f = 1, _ = {}, g = !1, y = e.document, v = Object.getPrototypeOf && Object.getPrototypeOf(e);
        ...
        var n = r(27), o = function (e, t) {
            var r = t || {}, o = r.bufferLen || 4096, i = r.numChannels || 2;
            ...
            var a = new n;
            a.postMessage({command: "init", config: {sampleRate: this.context.sampleRate, numChannels: i}});
            var s, u = !1;
            this.node.onaudioprocess = function (e) {
                if (u) {
                    for (var t = [], r = 0; r < i; r++)t.push(e.inputBuffer.getChannelData(r));
                    a.postMessage({command: "record", buffer: t})
                }
        ...
        o.forceDownload = function (e, t) {
            var r = (window.URL || window.webkitURL).createObjectURL(e), n = window.document.createElement("a");
